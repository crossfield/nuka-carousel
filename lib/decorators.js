...
var DefaultDecorators = [{
  ...
  component: _React2['default'].createClass({
        ...
        indexes.map(function (index) {
          return _React2['default'].createElement(
            ...
            _React2['default'].createElement(
              'button',
              {
                style: self.getButtonStyles(self.props.currentSlide === index, self.props.primaryColor, self.props.secondaryColor),
    ...
    getButtonStyles: function getButtonStyles(active, color1, color2) {
      var primaryColor = '#ffd65a';
      var secondaryColor =  '#004b85';
      return {
        border: 0,
